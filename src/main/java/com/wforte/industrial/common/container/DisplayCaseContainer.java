package com.wforte.industrial.common.container;
...
public class DisplayCaseContainer extends Container {
	...
	public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			stack = stack1.copy();
			if(index < DisplayCaseTileEntity.slots && !this.mergeItemStack(stack1, DisplayCaseTileEntity.slots, this.inventorySlots.size(), false)) {
