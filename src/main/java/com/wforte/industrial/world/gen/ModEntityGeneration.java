...
public class ModEntityGeneration {
    ...
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToAllBiomes(event.getSpawns(), ModEntityTypes.BUFF_ZOMBIE.get(), 40, 3, 6);
        addEntityToAllBiomes(event.getSpawns(), ModEntityTypes.KNUCKLE_DRAGGER.get(), 50, 6, 8);
        addEntityToAllBiomes(event.getSpawns(), ModEntityTypes.HOG.get(), 30, 6, 8);
    }
