package com.wforte.industrial.client.screen;
...
public class DisplayCaseScreen extends ContainerScreen<DisplayCaseContainer> {
	...
	private static final ResourceLocation DISPLAY_CASE_GUI = new ResourceLocation(IndustrialMod.MOD_ID, "textures/gui/display_case.png");
